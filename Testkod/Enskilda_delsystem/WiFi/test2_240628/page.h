...
<body>
  ...
  <div class="container">
    ...
    <div class="control-card">
      <h2>Moveable mass controls</h2>
      <table class="fixed-table">
        <tr>
          <th>Rotation angle of mass</th>      
          <th>Displacement of mass</th>
        </tr>
        <tr>
          <td id="rotationAngle"></td>
          <td id="displacementPosition"></td>
        </tr>
      </table>
  ...
  <script>
    ...
    function fetchData() {
      ...
      .then(data => {
        ...
        document.getElementById('displacementPosition').innerText = data.displacementPosition + " cm";
