/*
  ...
  * The code supports message forwarding to another tracker/RockBLOCK via the Rock7 RockBLOCK Gateway
  ...
  where nnn is the message interval in _minutes_. The square brackets are essential.
...
extern "C" void am_rtc_isr(void)
{
  ...
  if (secondsCount >= (myTrackerSettings.TXINT * 60))
  {
    intervalAlarm = true;
    secondsCount = 0;
  }
    ...
    case zzz:
      {
        ...
        while (!intervalAlarm) // Wake up every TXINT minutes
        {
          // Go to Deep Sleep.
