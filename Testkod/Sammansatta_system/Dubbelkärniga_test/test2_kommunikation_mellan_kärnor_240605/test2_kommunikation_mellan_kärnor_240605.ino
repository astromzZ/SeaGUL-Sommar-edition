...
void printing(void* pvParameters) {
    ...
    while (true) {
        if (xQueueReceive(sensorDataQueue, &receivedData, portMAX_DELAY)) {
            Serial.print("Pitch from core 1:");
            Serial.println(receivedData.sensor1Data * 180 / PI);

            Serial.print("Roll from core 1:");
            Serial.println(receivedData.sensor2Data * 180 / PI);
        // Serial.print ("Hello");
...
void orientation(void* pvParameters) {
    ...
    // -160 * PI / 180;
            Serial.print("Pitch from core 0: ");
            Serial.print(data.sensor1Data * 180 / PI); // Convert to degrees
            Serial.print(" Roll from core 0: ");
