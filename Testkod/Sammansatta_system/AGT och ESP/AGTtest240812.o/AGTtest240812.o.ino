    ...
    case start_9603:
      ...
      else
      {
        ...
        if (myTrackerSettings.DEST > 0) {
          ...
          sprintf(outBuffer, "%s,%s,%d,%d", latStr, lonStr, agtPDOP, agtSatellites);
        }
...
#ifndef noTX
        agtErr = modem.sendSBDText(outBuffer) //, mt_buffer, mtBufferSize); // This could take many seconds to complete and will call ISBDCallback() periodically
#else
