...
void loop()
{
  ...
  switch (loop_step) {
    ...
    case start_GNSS:
        ...
        delay(1000); // Wait for the GNSS to power up

        Serial.println(F("GNSS powered up!"));

        loop_step = read_GNSS; // Go to the next step
    ...
    case read_GNSS:
        ...
        Serial.println(F("Reading GNSS fix..."));
        delay(1000); // Wait for the GNSS to get a fix
        Serial.println(F("GNSS fix read!"));
        delay(1000); 
        Serial.println(F("Powering down the GNSS..."));

        loop_step = start_LTC3225; // Go to the next step
    ...
    case start_LTC3225:
        ...
        Serial.println(F("Starting the supercapacitor charger..."));

        delay(1000); // Wait for the LTC3225 to start

        loop_step = wait_LTC3225; // Go to the next step
    ...
    case wait_LTC3225:
        ...
        Serial.println(F("Waiting for the supercapacitors to charge..."));
        delay(1000); // Wait for the super capacitors to charge
        Serial.println(F("Supercapacitors charged!"));

        loop_step = start_9603; // Go to the next step
    ...
    case start_9603:
        ...
        Serial.println(F("Powering up the 9603N..."));
        delay(1000); // Wait for the 9603N to power up
        Serial.println(F("9603N powered up!"));
        delay(1000);
