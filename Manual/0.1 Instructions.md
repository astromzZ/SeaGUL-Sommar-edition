...
<div style="float: right; margin-left: 10px;">
    <img src="./Bilder/webpage2.png" alt="Image 1" style="display:block; margin-bottom:10px;" width="150"  />
    <img src="./Bilder/Webpage.png" alt="Image 2" style="display:block;" width="150" />
</div>
To the right you can see the webpage which is used to controll the glider when it is at the surface. The website showcases sensor values, potentiometer value, ballast possition and allows the glider to enter some states. 
...
Error message doesn't indicate and issue, it is the latest message sent from the ESP32.
</span>
